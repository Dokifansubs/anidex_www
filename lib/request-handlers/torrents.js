...
exports.uploadFile = function(req, res) {
    console.log(req.files.torrent.path);
    console.log(Object.keys(req.files.torrent));
    console.log(req.files.torrent.type);
    if (req.files.torrent.type === 'application/x-bittorrent') {
        ...
        var torrent = {};
        torrent.name = "Not a torrent file";
        return res.send(torrent);
    }
}